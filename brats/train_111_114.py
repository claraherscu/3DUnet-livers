...
config["data_file"] = os.path.abspath("liver_data_111_114.h5")
config["model_file"] = os.path.abspath("tumor_segmentation_model_111_114.h5")
config["training_file"] = os.path.abspath("training_ids_111_114.pkl")
config["validation_file"] = os.path.abspath("validation_ids_111_114.pkl")
